...
### 2.4) Dimensionality reduction (UMAP)
...
### 3.1) Visualizing FlowSOM clusters 
...
### 3.3) Boolean matrix of marker positivity
...
#### 3.3.1) Plot UMAP of boolean markers
...
#### 3.3.2) Background subtracted (percent pos)
