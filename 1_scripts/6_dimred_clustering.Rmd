...
png(filename = glue("{dir_store}/clusterdistribution_marker_stackedbar.png"), height = 15,width = 15,unit = "in",res=300)
ggplot(df_plot, aes(x="", y=n_pos_backgroundsubtracted, fill=meta25))+
  geom_bar(width = 1, stat = "identity")+
  facet_wrap(~marker)+
...
n_labels <- ddply(.data=df_plot2, 
                 ...
                 summarize, 
                 n=paste("n =", round(sum(n_pos_backgroundsubtracted))))
ggplot(df_plot2, aes(x="", y=n_pos_backgroundsubtracted, fill=meta25))+
  geom_bar(width = 1, stat = "identity")+
